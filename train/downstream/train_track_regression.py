#!/usr/bin/env python3
"""CLI wrapper for downstream track-property regression training."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pretrained_ckpt", default=None, type=str, help="Optional pretrained checkpoint path.")
