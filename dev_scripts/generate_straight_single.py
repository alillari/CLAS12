...
OUT_DIR = "/workspace/PP_collision/data/mmap_straight_single"   # SEPARATE from real data/mmap

N_EVENTS = 8858            # same as the 3-particle straight set; only particle count changed (3 -> 1)
N_TRACKS_PER_EVENT = 1     # ONE straight track per event (fills the 4th corner)
TEST_FRACTION = 0.10
RANDOM_SEED = 1234
N_REG_COLS = 7
