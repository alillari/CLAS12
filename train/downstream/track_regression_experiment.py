...
def train_experiment(
    ...
    try:
        ...
        artifact_summary = {
            ...
            "regression_target_stats": json_safe(getattr(params, "regression_target_stats", None)),
            "regression_target_columns": json_safe(getattr(trainer, "regression_target_stats", {}).get("columns")),
